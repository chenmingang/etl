...
import com.github.chenmingang.mysql.dbsync.CharsetConversion;
...
public final class UserVarLogEvent extends LogEvent
{
     ...
     * otherwise. If this byte is 0, the following parts exist in the mysql.dbsync.event.</li>
    ...
    /* User_var mysql.dbsync.event data */
