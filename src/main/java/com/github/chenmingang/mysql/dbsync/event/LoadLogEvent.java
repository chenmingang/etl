...
/**
 * This log mysql.dbsync.event corresponds to a "LOAD DATA INFILE" SQL query on the following
 * form:
 * 
 * <pre>
 *    (1)    USE db;
 ...
 * mysql.dbsync.event (determined by the length field of the Common-Header)</td>
 * <td>The 'file_name' from the query.</td>
 * </tr>
 * 
 * </table>
 * 
 * This mysql.dbsync.event type is understood by current versions, but only generated by
...
public class LoadLogEvent extends LogEvent
{
    ...
    /* Load mysql.dbsync.event post-header */
    ...
    */
                                      ...
                                      FormatDescriptionLogEvent descriptionEvent)
    {
        ...
        if (header.type != LOAD_EVENT /* use_new_format */)
        {
             ...
             * feet during the lifetime of the mysql.dbsync.event. This assumption holds true
             ...
             * Create_file mysql.dbsync.event.
             */
