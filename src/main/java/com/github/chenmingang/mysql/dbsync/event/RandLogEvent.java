 ...
 * does not need it (it's repeatable again) so this mysql.dbsync.event needn't be written in
 ...
 * Binary Format
 * 
 * The Post-Header for this mysql.dbsync.event type is empty. The Body has two components:
 * 
 * <table>
