...
/**
 * In row-based mode, every row operation mysql.dbsync.event is preceded by a
 ...
 * to sizeof(float) on the server from which the mysql.dbsync.event originates.</td>
 * </tr>
 * 
 * <tr>
 ...
 * <td>1 byte</td>
 * <td>1 byte unsigned integer, representing the "pack_length", which is equal
 * to sizeof(double) on the server from which the mysql.dbsync.event originates.</td>
 * </tr>
 * 
 * <tr>
...
public final class TableMapLogEvent extends LogEvent
{
    ...
    /**
     * Constructor used by slave to read the mysql.dbsync.event from the binary log.
     */
                            ...
                            FormatDescriptionLogEvent descriptionEvent)
    {
        ...
        /* Read the variable part of the mysql.dbsync.event */
