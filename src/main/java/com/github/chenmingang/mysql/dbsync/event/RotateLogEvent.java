...
public final class RotateLogEvent extends LogEvent
{
     ...
     * 
     * <ul>
     * <li>8 bytes. The position of the first mysql.dbsync.event in the next log file. Always
     * contains the number 4 (meaning the next mysql.dbsync.event starts at position 4 in the
     ...
     * Its length is the mysql.dbsync.event size minus the size of the fixed parts.</li>
     * </ul>
     * 
    ...
    /* Rotate mysql.dbsync.event post-header */
