...
public abstract class RowsLogEvent extends LogEvent
{
     ...
     * determined by the size of the mysql.dbsync.event. Each row has the following format:
     * 
     * <ul>
    ...
    /** Last mysql.dbsync.event of a statement */
    ...
    /**
     * Indicates that rows in this mysql.dbsync.event are complete, that is contain values
