 ...
 * 
 * The mysql.dbsync.event is used to inform the slave that something out of the ordinary
 * happened on the master that might cause the database to be in an inconsistent
 * state.
 * 
 * <table id="IncidentFormat">
 * <caption>Incident mysql.dbsync.event format</caption>
 * <tr>
 * <th>Symbol</th>
 * <th>Format</th>
 * <th>Description</th>
...
public final class IncidentLogEvent extends LogEvent
{
    ...
    /** Shall be last mysql.dbsync.event of the enumeration */
                            ...
                            FormatDescriptionLogEvent descriptionEvent)
    {
        ...
        {
            // If the incident is not recognized, this binlog mysql.dbsync.event is
