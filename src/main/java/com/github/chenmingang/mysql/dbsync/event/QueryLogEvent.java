...
public class QueryLogEvent extends LogEvent
{
    ...
    Query-log-mysql.dbsync.event can carry.  It can redefined within a range
    ...
    /**
     * Max number of possible extra bytes in a replication mysql.dbsync.event compared to a
     ...
     * tables, there should be no mysql.dbsync.event with a non-zero error code (though it
     ...
     * compares the error code it got with the error code in the mysql.dbsync.event, and if
                         ...
                         FormatDescriptionLogEvent descriptionEvent) throws IOException
    {
        ...
        /*
         * We test if the mysql.dbsync.event's length is sensible, and if so we compute
        ...
        /* A 2nd variable part; this is tracker.common to all versions */
    ...
    /* query mysql.dbsync.event post-header */
            ...
            while (buffer.position() < end)
            {
                ...
                case Q_UPDATED_DB_NAMES:
                    ...
                    /**
                        ...
                        the master's MAX_DBS_IN_EVENT_MTS > the slave's one and the mysql.dbsync.event
